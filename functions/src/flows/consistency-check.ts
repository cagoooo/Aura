...
const PROMPT = `You are an expert story editor AI that analyzes the consistency of a story concept described by the 5W1H elements (Who, What, When, Where, Why, How).
